"""
The fixed version of laneGCN for development.
...
# config file from an isolated file
...
def get_model():
    """
    The main entrance of the model.
    :return:
    """

    # use the config dict from the isolated file
    net = Net(config)
    net = net.cuda()
